 ...
 let id = JSON.parse(localStorage.getItem("t_id"));
  $.ajax({
        ...
        success: function (response) {
            ...
            businessEmail.innerHTML=`${response.email}`;
            let businessPhone = document.getElementById("businessPhone");
            businessPhone.innerHTML=`${response.phone}`;
            let businessTel = document.getElementById("businessTel");
            businessTel.innerHTML=`${response.phone}`;
            ...
            let tenanttel = document.getElementById("tenanttel");
            tenanttel.innerHTML=`${response.phone}`;
