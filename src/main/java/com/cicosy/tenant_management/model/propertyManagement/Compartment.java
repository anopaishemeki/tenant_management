...
public class Compartment {
    ...
    public Compartment(Long property, int floorNumber, int floorArea, double rentalRate, boolean status, String compartmentNumber, Tenant tenantObject, Long tenant) {
